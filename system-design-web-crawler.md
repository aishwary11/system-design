...
> [!TIP]
> **TL;DR** — A distributed web crawler that systematically browses and downloads web pages for indexing, archiving, or data analysis.
...
<text x="113.6" y="310" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="11" fill="#475569">Web Crawler</text>
<path d="M402 132 L402 156 L419 156 L419 298 L403 298 L403 322" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-web-crawler)"/>
<path d="M403 384 L403 574" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-web-crawler)"/>
<path d="M383 636 L383 731 L144 731 L144 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-web-crawler)"/>
<path d="M403 636 L403 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-web-crawler)"/>
<path d="M423 636 L423 731 L660 731 L660 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-web-crawler)"/>
<path d="M144 888 L144 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-web-crawler)"/>
<path d="M402 888 L402 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-web-crawler)"/>
<path d="M660 888 L660 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-web-crawler)"/>
<path d="M144 1140 L144 1235 L382 1235 L382 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-web-crawler)"/>
<path d="M402 1140 L402 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-web-crawler)"/>
<path d="M660 1140 L660 1235 L422 1235 L422 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-web-crawler)"/>
<path d="M382 1392 L382 1487 L144 1487 L144 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-web-crawler)"/>
<path d="M402 1392 L402 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-web-crawler)"/>
<path d="M422 1392 L422 1487 L660 1487 L660 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-web-crawler)"/>
...
<text x="402" y="106" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#064e3b">Web UI</text>
...
<text x="144" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Crawler Svc</text>
...
<text x="402" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Parser Service</text>
...
<text x="660" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Index Service</text>
...
<text x="144" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Fetch Workers</text>
...
<text x="660" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Dedup Workers</text>
...
<text x="144" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#4c1d95">Redis URL Queue</text>
...
<text x="402" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#4c1d95">Cheerio + JSdom</text>
...
<text x="660" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#4c1d95">Elasticsearch</text>
...
<defs><marker id="arr-web-crawler" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="9" markerHeight="9" markerUnits="userSpaceOnUse" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#64748b"/></marker><marker id="arrEm-web-crawler" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="9" markerHeight="9" markerUnits="userSpaceOnUse" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#10b981"/></marker></defs>
</svg>
