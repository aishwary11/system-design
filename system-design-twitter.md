...
![Twitter — System Architecture](diagrams/system-design/twitter.svg)
...
| ✅ Do | ❌ Don't |
| :-- | :-- |
| Pin down the key numbers before drawing boxes | Don't hand-wave the hardest component — twitter lives or dies there |
...
<nav>← [tinder](system-design-tinder.md) · [📖 All guides](README.md) · [uber](system-design-uber.md) →</nav>
