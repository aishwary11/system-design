...
> [!TIP]
> **TL;DR** — A location-based dating platform supporting profile discovery, swiping, matching, messaging, and preferences for 50M+ daily active users.
...
<text x="95.6" y="310" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="11" fill="#475569">Tinder</text>
<path d="M423 132 L423 156 L440 156 L440 298 L424 298 L424 322" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-tinder)"/>
<path d="M424 384 L424 574" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-tinder)"/>
<path d="M404 636 L404 731 L165 731 L165 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-tinder)"/>
<path d="M424 636 L424 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-tinder)"/>
<path d="M444 636 L444 731 L681 731 L681 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-tinder)"/>
<path d="M165 888 L165 983 L149 983 L149 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-tinder)"/>
<path d="M423 888 L423 912 L439 912 L439 1054 L412 1054 L412 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-tinder)"/>
<path d="M681 888 L681 912 L702 912 L702 1054 L686 1054 L686 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-tinder)"/>
<path d="M149 1140 L149 1235 L403 1235 L403 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-tinder)"/>
<path d="M423 1140 L423 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-tinder)"/>
<path d="M686 1140 L686 1235 L443 1235 L443 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-tinder)"/>
<path d="M403 1392 L403 1487 L165 1487 L165 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-tinder)"/>
<path d="M423 1392 L423 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-tinder)"/>
<path d="M443 1392 L443 1487 L681 1487 L681 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-tinder)"/>
...
<text x="165" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Matching Svc</text>
...
<text x="423" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Profile Service</text>
...
<text x="681" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Chat Service</text>
...
<text x="165" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Match Workers</text>
...
<text x="412" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#4c1d95">S3 + CDN</text>
<rect x="596" y="1081" width="180" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="596" y="1078" width="180" height="62" rx="12" fill="#f5f3ff" stroke="#8b5cf6" stroke-width="1.4"/>
<rect x="599" y="1081" width="174" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="686" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#4c1d95">WebSocket + Cassandra</text>
...
<defs><marker id="arr-tinder" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="9" markerHeight="9" markerUnits="userSpaceOnUse" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#64748b"/></marker><marker id="arrEm-tinder" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="9" markerHeight="9" markerUnits="userSpaceOnUse" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#10b981"/></marker></defs>
</svg>
