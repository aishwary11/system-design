...
> [!TIP]
> **TL;DR** — A smart parking management system that enables real-time parking spot discovery, reservation, guided navigation, automated entry/exit, and payment processing.
...
| Metric | Value |
| :--- | :--- |
| **parking spots across 500+ lots** | 50K+ |
| **registered users** | 1M+ |
| **daily reservations** | 100K+ |
...
<path d="M407 132 L407 156 L424 156 L424 298 L408 298 L408 322" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-parking-system)"/>
<path d="M408 384 L408 408 L424 408 L424 550 L407 550 L407 574" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-parking-system)"/>
<path d="M387 636 L387 731 L149 731 L149 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-parking-system)"/>
<path d="M407 636 L407 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-parking-system)"/>
<path d="M427 636 L427 731 L665 731 L665 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-parking-system)"/>
<path d="M149 888 L149 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-parking-system)"/>
<path d="M407 888 L407 912 L428 912 L428 1054 L412 1054 L412 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-parking-system)"/>
<path d="M665 888 L665 912 L686 912 L686 1054 L670 1054 L670 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-parking-system)"/>
<path d="M149 1140 L149 1235 L387 1235 L387 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-parking-system)"/>
<path d="M407 1140 L407 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-parking-system)"/>
<path d="M670 1140 L670 1235 L427 1235 L427 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-parking-system)"/>
<path d="M387 1392 L387 1487 L149 1487 L149 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-parking-system)"/>
<path d="M407 1392 L407 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-parking-system)"/>
<path d="M427 1392 L427 1487 L665 1487 L665 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-parking-system)"/>
...
<rect x="333" y="577" width="148" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="333" y="574" width="148" height="62" rx="12" fill="#eef2ff" stroke="#6366f1" stroke-width="1.4"/>
<rect x="336" y="577" width="142" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="407" y="610" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Load Balancer</text>
...
<text x="149" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Booking Svc</text>
...
<text x="407" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Slot Manager</text>
...
<text x="665" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Payment Svc</text>
...
<text x="149" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">IoT Workers</text>
...
<text x="412" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#4c1d95">Redis GEO + IoT</text>
...
<text x="670" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#4c1d95">Stripe</text>
...
<defs><marker id="arr-parking-system" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="9" markerHeight="9" markerUnits="userSpaceOnUse" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#64748b"/></marker><marker id="arrEm-parking-system" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="9" markerHeight="9" markerUnits="userSpaceOnUse" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#10b981"/></marker></defs>
</svg>
