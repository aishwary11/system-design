...
<text x="110" y="310" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="11" fill="#475569">E-Commerce</text>
<path d="M412 132 L412 156 L429 156 L429 298 L413 298 L413 322" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-ecommerce)"/>
<path d="M413 384 L413 574" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-ecommerce)"/>
<path d="M393 636 L393 731 L154 731 L154 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-ecommerce)"/>
<path d="M413 636 L413 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-ecommerce)"/>
<path d="M433 636 L433 731 L670 731 L670 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-ecommerce)"/>
<path d="M154 888 L154 912 L170 912 L170 1054 L149 1054 L149 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-ecommerce)"/>
<path d="M412 888 L412 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-ecommerce)"/>
<path d="M670 888 L670 912 L691 912 L691 1054 L675 1054 L675 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-ecommerce)"/>
<path d="M149 1140 L149 1235 L392 1235 L392 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-ecommerce)"/>
<path d="M412 1140 L412 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-ecommerce)"/>
<path d="M675 1140 L675 1235 L432 1235 L432 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-ecommerce)"/>
<path d="M392 1392 L392 1487 L154 1487 L154 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-ecommerce)"/>
<path d="M412 1392 L412 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-ecommerce)"/>
<path d="M432 1392 L432 1487 L670 1487 L670 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-ecommerce)"/>
...
<text x="154" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Product Svc</text>
...
<text x="412" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Cart Service</text>
...
<text x="670" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Order Service</text>
...
<text x="154" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Order Workers</text>
...
<text x="412" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#4c1d95">Redis + DynamoDB</text>
<rect x="596" y="1081" width="158" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="596" y="1078" width="158" height="62" rx="12" fill="#f5f3ff" stroke="#8b5cf6" stroke-width="1.4"/>
<rect x="599" y="1081" width="152" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="675" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#4c1d95">PostgreSQL + Kafka</text>
...
<defs><marker id="arr-ecommerce" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="9" markerHeight="9" markerUnits="userSpaceOnUse" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#64748b"/></marker><marker id="arrEm-ecommerce" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="9" markerHeight="9" markerUnits="userSpaceOnUse" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#10b981"/></marker></defs>
</svg>
