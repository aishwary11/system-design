...
<rect x="124" y="540" width="700" height="114" rx="14" fill="none" stroke="#cbd5e1" stroke-width="1.3" stroke-dasharray="7 5"/>
<rect x="136" y="548" width="77.6" height="20" rx="10" fill="#ffffff" stroke="#e2e8f0" stroke-width="1"/>
<text x="174.8" y="562" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="11" fill="#475569">Consumer</text>
<path d="M156 132 L156 227 L454 227 L454 322" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-kafka-at-a-glance)"/>
<path d="M453 132 L453 227 L474 227 L474 322" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-kafka-at-a-glance)"/>
<path d="M771 132 L771 227 L494 227 L494 322" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-kafka-at-a-glance)"/>
<path d="M454 384 L454 479 L216 479 L216 574" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-kafka-at-a-glance)"/>
<path d="M474 384 L474 574" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-kafka-at-a-glance)"/>
<path d="M494 384 L494 479 L732 479 L732 574" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-kafka-at-a-glance)"/>
<path d="M216 636 L216 731 L454 731 L454 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-kafka-at-a-glance)"/>
<path d="M474 636 L474 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-kafka-at-a-glance)"/>
<path d="M732 636 L732 731 L494 731 L494 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-kafka-at-a-glance)"/>
<rect x="70" y="73" width="172" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="70" y="70" width="172" height="62" rx="12" fill="#eef2ff" stroke="#6366f1" stroke-width="1.4"/>
<rect x="73" y="73" width="166" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="156" y="106" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Application Services</text>
<rect x="352" y="73" width="201" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="352" y="70" width="201" height="62" rx="12" fill="#eef2ff" stroke="#6366f1" stroke-width="1.4"/>
<rect x="355" y="73" width="195" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="452.5" y="106" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Kafka Connect / Debezium</text>
<rect x="663" y="73" width="215" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="663" y="70" width="215" height="62" rx="12" fill="#eef2ff" stroke="#6366f1" stroke-width="1.4"/>
<rect x="666" y="73" width="209" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="770.5" y="106" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Kafka Streams</text>
<rect x="142" y="577" width="148" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="142" y="574" width="148" height="62" rx="12" fill="#eef2ff" stroke="#6366f1" stroke-width="1.4"/>
<rect x="145" y="577" width="142" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="216" y="610" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Shipping</text>
<rect x="400" y="577" width="148" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="400" y="574" width="148" height="62" rx="12" fill="#eef2ff" stroke="#6366f1" stroke-width="1.4"/>
<rect x="403" y="577" width="142" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="474" y="610" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Analytics</text>
<rect x="658" y="577" width="148" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="658" y="574" width="148" height="62" rx="12" fill="#eef2ff" stroke="#6366f1" stroke-width="1.4"/>
<rect x="661" y="577" width="142" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="732" y="610" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Search Indexer</text>
<rect x="400" y="829" width="148" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="400" y="826" width="148" height="62" rx="12" fill="#f5f3ff" stroke="#8b5cf6" stroke-width="1.4"/>
<rect x="403" y="829" width="142" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="474" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#4c1d95">Postgres / S3</text>
<rect x="375" y="325" width="198" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="375" y="322" width="198" height="62" rx="12" fill="#fff7ed" stroke="#f97316" stroke-width="1.4"/>
<rect x="378" y="325" width="192" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="474" y="358" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#7c2d12">Brokers</text>
<defs><marker id="arr-kafka-at-a-glance" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="9" markerHeight="9" markerUnits="userSpaceOnUse" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#64748b"/></marker><marker id="arrEm-kafka-at-a-glance" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="9" markerHeight="9" markerUnits="userSpaceOnUse" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#10b981"/></marker></defs>
</svg>
