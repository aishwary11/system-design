...
![Route Reconstruction — System Architecture](diagrams/system-design/route-reconstruction.svg)
...
| ✅ Do | ❌ Don't |
| :-- | :-- |
| Pin down the key numbers before drawing boxes | Don't hand-wave the hardest component — route reconstruction lives or dies there |
