...
> [!TIP]
> **TL;DR** — Hotstar (now Disney+ Hotstar) is a large-scale video streaming platform supporting live sports (cricket, football), entertainment shows, and Video-on-Demand (VOD).
...
| **concurrent live viewers during peak events** | 25M+ |
| **hours of content** | 100K+ |
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 1762" width="900" role="img" aria-label="Hotstar — System Architecture">
...
<text x="99.2" y="310" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="11" fill="#475569">Hotstar</text>
<path d="M412 132 L412 156 L429 156 L429 298 L413 298 L413 322" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-hotstar)"/>
<path d="M413 384 L413 408 L429 408 L429 550 L412 550 L412 574" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-hotstar)"/>
<path d="M392 636 L392 731 L154 731 L154 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-hotstar)"/>
<path d="M412 636 L412 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-hotstar)"/>
<path d="M432 636 L432 731 L670 731 L670 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-hotstar)"/>
<path d="M154 888 L154 912 L170 912 L170 1054 L144 1054 L144 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-hotstar)"/>
<path d="M412 888 L412 912 L428 912 L428 1054 L411 1054 L411 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-hotstar)"/>
<path d="M670 888 L670 912 L695 912 L695 1054 L679 1054 L679 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-hotstar)"/>
<path d="M144 1140 L144 1235 L392 1235 L392 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-hotstar)"/>
<path d="M412 1140 L412 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-hotstar)"/>
<path d="M679 1140 L679 1235 L432 1235 L432 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-hotstar)"/>
<path d="M392 1392 L392 1487 L155 1487 L155 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-hotstar)"/>
<path d="M412 1392 L412 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-hotstar)"/>
<path d="M432 1392 L432 1487 L679 1487 L679 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-hotstar)"/>
...
<text x="412" y="106" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#064e3b">Mobile / Web</text>
...
<text x="154" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Streaming Svc</text>
...
<text x="412" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Live Score Svc</text>
...
<text x="670" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Chat Svc</text>
<rect x="72" y="1585" width="165" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="72" y="1582" width="165" height="62" rx="12" fill="#eef2ff" stroke="#6366f1" stroke-width="1.4"/>
<rect x="75" y="1585" width="159" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="154.5" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Transcoding Workers</text>
<rect x="347" y="1585" width="148" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="347" y="1582" width="148" height="62" rx="12" fill="#eef2ff" stroke="#6366f1" stroke-width="1.4"/>
<rect x="350" y="1585" width="142" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="421" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Analytics</text>
<rect x="605" y="1585" width="148" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="605" y="1582" width="148" height="62" rx="12" fill="#eef2ff" stroke="#6366f1" stroke-width="1.4"/>
<rect x="608" y="1585" width="142" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="679" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Notifications</text>
...
<text x="144" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#4c1d95">FFmpeg + CDN</text>
<rect x="328" y="1081" width="165" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="328" y="1078" width="165" height="62" rx="12" fill="#f5f3ff" stroke="#8b5cf6" stroke-width="1.4"/>
<rect x="331" y="1081" width="159" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="410.5" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#4c1d95">Redis (live scores)</text>
<rect x="603" y="1081" width="151" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="603" y="1078" width="151" height="62" rx="12" fill="#f5f3ff" stroke="#8b5cf6" stroke-width="1.4"/>
<rect x="606" y="1081" width="145" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="678.5" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#4c1d95">WebSocket + Redis</text>
...
<defs><marker id="arr-hotstar" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="9" markerHeight="9" markerUnits="userSpaceOnUse" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#64748b"/></marker><marker id="arrEm-hotstar" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="9" markerHeight="9" markerUnits="userSpaceOnUse" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#10b981"/></marker></defs>
</svg>
