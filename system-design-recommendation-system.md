...
| ✅ Do | ❌ Don't |
| :-- | :-- |
| Pin down the key numbers before drawing boxes | Don't hand-wave the hardest component — recommendation system lives or dies there |
...
<nav>← [rate limiter](system-design-rate-limiter.md) · [📖 All guides](README.md) · [reddit](system-design-reddit.md) →</nav>
