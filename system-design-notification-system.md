...
> [!TIP]
> **TL;DR** — A multi-channel notification system supporting push, email, SMS, and in-app notifications for millions of users.
...
<text x="142.4" y="310" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="11" fill="#475569">Notification System</text>
<path d="M412 132 L412 156 L429 156 L429 298 L413 298 L413 322" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-notification-system)"/>
<path d="M413 384 L413 574" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-notification-system)"/>
<path d="M393 636 L393 731 L154 731 L154 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-notification-system)"/>
<path d="M413 636 L413 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-notification-system)"/>
<path d="M433 636 L433 731 L670 731 L670 826" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-notification-system)"/>
<path d="M154 888 L154 912 L170 912 L170 1054 L149 1054 L149 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-notification-system)"/>
<path d="M412 888 L412 912 L433 912 L433 1054 L417 1054 L417 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-notification-system)"/>
<path d="M670 888 L670 912 L696 912 L696 1054 L680 1054 L680 1078" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-notification-system)"/>
<path d="M149 1140 L149 1235 L392 1235 L392 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-notification-system)"/>
<path d="M412 1140 L412 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-notification-system)"/>
<path d="M680 1140 L680 1235 L432 1235 L432 1330" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-notification-system)"/>
<path d="M392 1392 L392 1487 L154 1487 L154 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-notification-system)"/>
<path d="M412 1392 L412 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-notification-system)"/>
<path d="M432 1392 L432 1487 L670 1487 L670 1582" fill="none" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr-notification-system)"/>
...
<rect x="330" y="577" width="165" height="62" rx="12" fill="#0f172a" fill-opacity="0.08"/>
<rect x="330" y="574" width="165" height="62" rx="12" fill="#eef2ff" stroke="#6366f1" stroke-width="1.4"/>
<rect x="333" y="577" width="159" height="56" rx="9" fill="none" stroke="#ffffff" stroke-opacity="0.5" stroke-width="1"/>
<text x="412.5" y="610" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Load Balancer (ALB)</text>
...
<text x="154" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Notification Svc</text>
...
<text x="412" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Template Svc</text>
...
<text x="670" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Preference Svc</text>
...
<text x="154" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Push Workers</text>
...
<text x="412" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">Email Workers</text>
...
<text x="670" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#312e81">SMS Workers</text>
...
<text x="417" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#4c1d95">Handlebars + Redis</text>
...
<text x="680" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#4c1d95">PostgreSQL</text>
...
<defs><marker id="arr-notification-system" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="9" markerHeight="9" markerUnits="userSpaceOnUse" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#64748b"/></marker><marker id="arrEm-notification-system" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="9" markerHeight="9" markerUnits="userSpaceOnUse" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#10b981"/></marker></defs>
</svg>
