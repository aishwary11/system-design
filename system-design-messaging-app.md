...
<text x="66" y="308" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="12" fill="#334155">Messaging App</text>
<path d="M409 132 L409 156 L425 156 L425 298 L409 298 L409 322" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-messaging-app)"/>
<path d="M409 384 L409 408 L425 408 L425 550 L409 550 L409 574" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-messaging-app)"/>
<path d="M389 636 L389 731 L151 731 L151 826" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-messaging-app)"/>
<path d="M409 636 L409 826" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-messaging-app)"/>
<path d="M429 636 L429 731 L667 731 L667 826" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-messaging-app)"/>
<path d="M151 888 L151 912 L167 912 L167 1054 L146 1054 L146 1078" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-messaging-app)"/>
<path d="M409 888 L409 912 L425 912 L425 1054 L405 1054 L405 1078" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-messaging-app)"/>
<path d="M667 888 L667 912 L684 912 L684 1054 L668 1054 L668 1078" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-messaging-app)"/>
<path d="M146 1140 L146 1235 L389 1235 L389 1330" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-messaging-app)"/>
<path d="M409 1140 L409 1330" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-messaging-app)"/>
<path d="M668 1140 L668 1235 L429 1235 L429 1330" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-messaging-app)"/>
<path d="M389 1392 L389 1487 L151 1487 L151 1582" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-messaging-app)"/>
<path d="M409 1392 L409 1582" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-messaging-app)"/>
<path d="M429 1392 L429 1487 L667 1487 L667 1582" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-messaging-app)"/>
<rect x="335" y="70" width="148" height="62" rx="9" fill="#ecfdf5" stroke="#059669" stroke-width="1.6"/>
<text x="409" y="106" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#065f46">Mobile / Web</text>
<rect x="328" y="322" width="161" height="62" rx="9" fill="#eef2ff" stroke="#6366f1" stroke-width="1.6"/>
<text x="408.5" y="358" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#3730a3">WAF / API Gateway</text>
<rect x="335" y="574" width="148" height="62" rx="9" fill="#eef2ff" stroke="#6366f1" stroke-width="1.6"/>
<text x="409" y="610" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#3730a3">Load Balancer</text>
<rect x="77" y="826" width="148" height="62" rx="9" fill="#eef2ff" stroke="#6366f1" stroke-width="1.6"/>
<text x="151" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#3730a3">Chat Service</text>
<rect x="335" y="826" width="148" height="62" rx="9" fill="#eef2ff" stroke="#6366f1" stroke-width="1.6"/>
<text x="409" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#3730a3">Media Service</text>
<rect x="593" y="826" width="148" height="62" rx="9" fill="#eef2ff" stroke="#6366f1" stroke-width="1.6"/>
<text x="667" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#3730a3">Presence Svc</text>
<rect x="77" y="1582" width="148" height="62" rx="9" fill="#eef2ff" stroke="#6366f1" stroke-width="1.6"/>
<text x="151" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#3730a3">Push Workers</text>
<rect x="335" y="1582" width="148" height="62" rx="9" fill="#eef2ff" stroke="#6366f1" stroke-width="1.6"/>
<text x="409" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#3730a3">Analytics</text>
<rect x="593" y="1582" width="148" height="62" rx="9" fill="#eef2ff" stroke="#6366f1" stroke-width="1.6"/>
<text x="667" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#3730a3">Media Transcoder</text>
<rect x="70" y="1078" width="151" height="62" rx="9" fill="#f5f3ff" stroke="#7c3aed" stroke-width="1.6"/>
<text x="145.5" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#5b21b6">Cassandra + Redis</text>
<rect x="331" y="1078" width="148" height="62" rx="9" fill="#f5f3ff" stroke="#7c3aed" stroke-width="1.6"/>
<text x="405" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#5b21b6">S3 + CDN</text>
<rect x="589" y="1078" width="158" height="62" rx="9" fill="#f5f3ff" stroke="#7c3aed" stroke-width="1.6"/>
<text x="668" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#5b21b6">Redis (heartbeats)</text>
<rect x="335" y="1330" width="148" height="62" rx="9" fill="#fff7ed" stroke="#ea580c" stroke-width="1.6"/>
<text x="409" y="1366" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#9a3412">Kafka</text>
<defs><marker id="arr-messaging-app" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#334155"/></marker></defs>
</svg>
