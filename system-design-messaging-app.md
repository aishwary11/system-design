...
![Messaging App — System Architecture](diagrams/system-design/messaging-app.svg)
...
| ✅ Do | ❌ Don't |
| :-- | :-- |
| Pin down the key numbers before drawing boxes | Don't hand-wave the hardest component — messaging app lives or dies there |
