...
<title>Alerting — System Architecture</title>
<rect x="52" y="288" width="713" height="1374" rx="10" fill="none" stroke="#94a3b8" stroke-width="1.5" stroke-dasharray="6 4"/>
<text x="66" y="308" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="12" fill="#334155">Alerting &amp; Monitoring Platform</text>
<path d="M409 132 L409 156 L425 156 L425 298 L409 298 L409 322" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-alerting)"/>
<path d="M409 384 L409 574" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-alerting)"/>
<path d="M389 636 L389 731 L151 731 L151 826" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-alerting)"/>
<path d="M409 636 L409 826" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-alerting)"/>
<path d="M429 636 L429 731 L667 731 L667 826" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-alerting)"/>
<path d="M151 888 L151 1078" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-alerting)"/>
<path d="M409 888 L409 912 L430 912 L430 1054 L414 1054 L414 1078" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-alerting)"/>
<path d="M667 888 L667 912 L688 912 L688 1054 L672 1054 L672 1078" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-alerting)"/>
<path d="M151 1140 L151 1235 L389 1235 L389 1330" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-alerting)"/>
<path d="M409 1140 L409 1330" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-alerting)"/>
<path d="M672 1140 L672 1235 L429 1235 L429 1330" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-alerting)"/>
<path d="M389 1392 L389 1487 L146 1487 L146 1582" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-alerting)"/>
<path d="M409 1392 L409 1582" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-alerting)"/>
<path d="M429 1392 L429 1487 L668 1487 L668 1582" fill="none" stroke="#334155" stroke-width="1.6" marker-end="url(#arr-alerting)"/>
<rect x="335" y="70" width="148" height="62" rx="9" fill="#ecfdf5" stroke="#059669" stroke-width="1.6"/>
<text x="409" y="106" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#065f46">Services / Probes</text>
<rect x="328" y="322" width="161" height="62" rx="9" fill="#eef2ff" stroke="#6366f1" stroke-width="1.6"/>
<text x="408.5" y="358" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#3730a3">Ingest Gateway</text>
...
<text x="151" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#3730a3">Metrics Ingest Svc</text>
<rect x="335" y="826" width="148" height="62" rx="9" fill="#eef2ff" stroke="#6366f1" stroke-width="1.6"/>
<text x="409" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#3730a3">Query Svc</text>
<rect x="593" y="826" width="148" height="62" rx="9" fill="#eef2ff" stroke="#6366f1" stroke-width="1.6"/>
<text x="667" y="862" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#3730a3">Alertmanager Svc</text>
<rect x="70" y="1582" width="151" height="62" rx="9" fill="#eef2ff" stroke="#6366f1" stroke-width="1.6"/>
<text x="145.5" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#3730a3">Downsamplers</text>
<rect x="331" y="1582" width="148" height="62" rx="9" fill="#eef2ff" stroke="#6366f1" stroke-width="1.6"/>
<text x="405" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#3730a3">Anomaly Detector</text>
<rect x="589" y="1582" width="158" height="62" rx="9" fill="#eef2ff" stroke="#6366f1" stroke-width="1.6"/>
<text x="668" y="1618" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#3730a3">On-Call Pager</text>
<rect x="72" y="1078" width="158" height="62" rx="9" fill="#f5f3ff" stroke="#7c3aed" stroke-width="1.6"/>
<text x="151" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#5b21b6">TSDB (M3 / Cortex)</text>
<rect x="340" y="1078" width="148" height="62" rx="9" fill="#f5f3ff" stroke="#7c3aed" stroke-width="1.6"/>
<text x="414" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#5b21b6">Redis (Active Alerts)</text>
<rect x="598" y="1078" width="148" height="62" rx="9" fill="#f5f3ff" stroke="#7c3aed" stroke-width="1.6"/>
<text x="672" y="1114" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#5b21b6">ClickHouse (LTS)</text>
<rect x="335" y="1330" width="148" height="62" rx="9" fill="#fff7ed" stroke="#ea580c" stroke-width="1.6"/>
<text x="409" y="1366" text-anchor="middle" font-family="JetBrains Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="13" font-weight="bold" fill="#9a3412">Kafka (Metrics Stream)</text>
<defs><marker id="arr-alerting" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#334155"/></marker></defs>
</svg>
