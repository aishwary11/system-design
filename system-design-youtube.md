...
![Youtube — System Architecture](diagrams/system-design/youtube.svg)
...
| ✅ Do | ❌ Don't |
| :-- | :-- |
| Pin down the key numbers before drawing boxes | Don't hand-wave the hardest component — youtube lives or dies there |
...
<nav>← [web crawler](system-design-web-crawler.md) · [📖 All guides](README.md) · [STUDY ROADMAP](STUDY-ROADMAP.md) →</nav>
