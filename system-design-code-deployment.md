...
| ✅ Do | ❌ Don't |
| :-- | :-- |
| Pin down the key numbers before drawing boxes | Don't hand-wave the hardest component — code deployment lives or dies there |
...
<nav>← [alerting](system-design-alerting.md) · [📖 All guides](README.md) · [concepts](system-design-concepts.md) →</nav>
